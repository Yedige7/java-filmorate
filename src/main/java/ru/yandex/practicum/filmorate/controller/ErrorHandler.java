...
public class ErrorHandler {
    ...
    @ExceptionHandler({DuplicatedDataException.class, ValidationException.class, ConditionsNotMetException.class})
    ...
    public Map<String, String> handleOtherExceptions(final Throwable e) {
        return Map.of("Произошла непредвиденная ошибка.", "Внутренняя ошибка сервера.");
    }
    ...
    public Map<String, String> handleOtherExceptions(final Exception e) {
        ...
        return Map.of("error", "Internal server error", "exception_class", e.getClass().getName(), "message", e.getMessage() != null ? e.getMessage() : "No message available");
    }
}
